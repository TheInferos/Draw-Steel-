  ...
  const seedData: SeedData = {
    ...
    cultures: [
      { 
        ...
        skillGroup: ['Exploration', 'Interpersonal'],
        quickBuild: 'Navigate'
      },
      { 
        name: 'Rural', 
      ...
      { 
        ...
        skillGroup: ['Interpersonal', 'Lore'],
        quickBuild: 'Read Person'
      },
      { 
        name: 'Urban', 
        ...
        skillGroup: ['Interpersonal', 'Intrigue'],
      ...
      { 
        ...
        skillGroup: ['Crafting', 'Exploration'],
        ...
        <div className="mb-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              ...
              <li>• {seedData.cultures.length} Cultures (Imperial, Nomadic, Mountain, etc.)</li>
